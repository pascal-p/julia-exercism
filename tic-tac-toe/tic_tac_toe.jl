...
#
# @time interactive_play(4)
# O plays move to cell 12
# |----|----|----|----|
# | O  | X  | O  | O  |
# |----|----|----|----|
# | O  | X  | X  | X  |
...
#
# O wins!
#  76.821873 seconds (1.57 G allocations: 91.526 GiB, 6.57% gc time)
# :O
#
# O plays move to cell 3
# |----|----|----|----|
# | O  | O  | O  | O  |
# |----|----|----|----|
# | X  | X  | _  | _  |
...
#
# O wins!
#  90.307182 seconds (1.86 G allocations: 108.892 GiB, 7.89% gc time)
# :O
