...
@testset "intersection" begin
  ...
  @testset "not in-place" begin
    ...
    @test isempty(CustomSet([1, 2, 3]) ∩ CustomSet([4, 5, 6]))

    @test intersect(CustomSet([1, 2, 3, 4]), CustomSet([3, 2, 5])) == CustomSet([2, 3])
    @test CustomSet([1, 2, 3, 4]) ∩ CustomSet([3, 2, 5]) == CustomSet([2, 3])

    @test CustomSet([1, 2, 3, 4]) ∩ CustomSet([1, 3, 2, 4, 5]) == CustomSet([1, 2, 3, 4])
  end
end
