...
@testset "with multi-quotations" begin
  @test wordcount("Cool, I'm on it Now, how about you? Cool \"101\" let's do it now!!") == Dict("now" => 2, "101"   => 1, "it"    => 2, "how"   => 1, "about" => 1, "you"   => 1, "i'm"   => 1,"do"    => 1,"cool"  => 2,"on"    => 1, "let's" => 1)
end

@testset "non_alphanumeric" begin
  @test wordcount("hey,my_spacebar_is_broken") == Dict("hey" => 1, "my" => 1, "spacebar" => 1, "is" => 1, "broken" =>1)
end
