...
@testset "detects two or more anagrams (onlyonce)" begin
  @test detect_anagrams("master", ["stream", "pigeon", "stream", "maters"]) == ["stream", "maters"]
  @test detect_anagrams("live", ["life", "countries",  "vile", "evil", "headdress",
                                 "concealing", "veil", "one", "vile",
                                 "olive"]) == ["vile", "evil", "veil"]
end
...
@testset "detects three anagrams" begin
  @test detect_anagrams("allergy", ["gallery", "ballerina", "regally", "clergy",
                                    "largely", "leading"]) == ["gallery", "regally", "largely"]
end
