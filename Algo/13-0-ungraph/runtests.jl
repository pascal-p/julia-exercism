...
@testset "basics on undirected graph + bfs" begin
  ...
  @testset "undirected graph" begin
    ...
    sort_edges!(ug)                               ## default ordering by cost from cheapest to highest
    @test edges(ug) == [(6, 7, -9442), (1, 2, -8737), (5, 6, -7925),
                        (8, 9, -7664), (2, 3, -6040), (1, 10, -5950),
                        (3, 4, -2771), (9, 10, 555), (7, 2, 2119),
                        (4, 5, 7075), (7, 8, 9877)]
    
    sort_edges!(ug; rev=true)                     ## reverse ordering by cost from highest to cheapest
    @test edges(ug) == [(7, 8, 9877), (4, 5, 7075), (7, 2, 2119),
                        (9, 10, 555), (3, 4, -2771), (1, 10, -5950),
                        (2, 3, -6040), (8, 9, -7664),
                        (5, 6, -7925), (1, 2, -8737), (6, 7, -9442)]

    sort_edges!(ug; by=((x, y, _c)=t) -> (x, y))  ## by vertex origin, vertex destination
    @test edges(ug) == [(1, 2, -8737), (1, 10, -5950), (2, 3, -6040),
                        (3, 4, -2771), (4, 5, 7075), (5, 6, -7925),
                        (6, 7, -9442), (7, 2, 2119), (7, 8, 9877),
                        (8, 9, -7664), (9, 10, 555)]
  end
