...
The Strassen algorithm takes this one step further and replaces the 8 multiplications above by 7 carefully chosen ones, thus 1 less recursive call replaced by a constant number of additional additions and substractions.
...
The running time of the Strassen algorithm can be found by using the Master Method (parameterized by 3 var. a, b and d) as follows:
  ...
  - d = 1 (outside the rec. call we need to do some additions and subtractions - which is done in linear
           time)
