...
@testset "Determine if expressions with non-brackets are correctly matched" begin
  ...
  @test matching_brackets("sdfhgkasdhfkashkd, 9sjdh, kahsdk9shdkajhd")        # no bracket at all
  @test !matching_brackets("sdfhgkasdhfkashkd (9sjdh) kahsdk9shdkajhd) sahdkahsk")
  @test !matching_brackets("[(sdfhgkasdhfkashkd (9sjdh) kahsdk9shdkajhd)}{]")
  @test !matching_brackets("[(sdfhgkasdhfkashkd (9sjdh) kahsdk9shdkajhd)]{{}]asasas")
  @test matching_brackets("[(sdfhgkasdhfkashkd (9sjdh) kahsdk9shdkajhd)][{{}}]asasas")
end
