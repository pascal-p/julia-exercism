...
# ╔═╡ 4c2a9c7b-f02c-4fec-a466-b4256f0fce19
begin
	using PlutoUI
	PlutoUI.TableOfContents(indent=true, depth=4, aside=true)
end

# ╔═╡ 55fe5b75-4ebd-4d71-92e8-4f5521b712f8
using GLMakie

# ╔═╡ b253bcd0-3bee-4249-842d-be519f8f9cca
using WaterLily

# ╔═╡ a9a7e532-e164-11ed-23be-1d16e91fc830
md"""
...
References: 
 - [Real-Time Fluid Dynamics Simulation in Julia using Waterlily.jl, GLMakie.jl](https://www.youtube.com/watch?v=hYbG7dFDCdU)
 - [Tutorial 08x13](https://github.com/julia4ta/tutorials/tree/master/Series%2008/Tutorial%2008x13)
"""

# ╔═╡ 4dc23c3f-45ab-44e3-a0a3-eddb41b2782b
function record_volume(sim, data_func; 
	...
	## Set up visualization data and figure (GLMakie)
    data = data_func(sim) |> d -> Observable(d)
    set_theme!(
		theme_dark(),
    ...
    record(fig, name, t) do tᵢ
		sim_step!(sim, tᵢ) # from WaterLily
        data[] = data_func(sim)
        println(
            "Simulation ",
            round(Int, (tᵢ - t₀) / duration * 100),
            "% complete"
        )
    end
    sim, fig
...
# ╔═╡ 9d84721a-8568-43c3-b09d-9fc4ecde09af
"""
	TGV(p, Re)
...
# ╔═╡ 20548729-31ac-483f-8b15-4dd6b95598e8
...
# ╔═╡ 0054a1af-654c-44b2-9cee-822623189e62
...
# ╔═╡ 4d349c27-0ce2-4212-b44c-e17dc0d01137
PlutoUI.LocalResource("TGV.mp4", :width => 500, :autoplay => "", :loop => false)

# ╔═╡ 3b5ec3c4-2407-46f8-817b-6b5ffc4ce4e2
html"""
<style>
  main {
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "5d7b26d86ec3fd74c0c7c186291e92074b350c1d"
