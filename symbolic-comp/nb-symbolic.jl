...
# ╔═╡ 2b361d4f-835b-4e22-80a5-468b27831b5d
md"""
### A bit of Algebra
"""

# ╔═╡ f62f194a-3f4a-4a2c-8e7e-a20f87e2826e
expr₀ = -4//3 * x + y ~ 2  # define an algebraic expression

# ╔═╡ 2b983312-6d61-4de0-aa74-538725f6315d
md"""
Now let's perform some symbolic calculations with this expression. We can solve it for $x$ and for $y$, as follows: 
"""

# ╔═╡ e1023a66-1b3f-41f4-b6dc-c5e8ad4e3a9c
Symbolics.solve_for(expr₀, x)

# ╔═╡ 4821c75e-031b-40da-80d3-f9c4f46a9bb9
Symbolics.solve_for(expr₀, y)

# ╔═╡ 23d14305-0837-4d12-bde8-c20de6fed184
md"""
### Linear Algebra

Let's define a system of 3 linear equations (in $x$, $y$ and $z$) and solve it using `Symbolics.jl`.
"""

# ╔═╡ 786932fe-3a30-4879-bafc-7658dd673eb1
expr₁ = 3x + 2y -z ~ 1

# ╔═╡ 7a8af269-9870-480f-b54e-5c9b4e8a51f5
expr₂ = 2x -2y + 4z ~ -2

# ╔═╡ 01f47e6e-4585-404c-9a18-0c3ddd38e462
expr₃ = -x + 1//2 * y -z ~ 0

# ╔═╡ c0151737-6e51-40c3-80b9-6be80c21cd06
Symbolics.solve_for([expr₁, expr₂, expr₃], [x, y, z])

# ╔═╡ 280d7a38-28b1-456a-a9fe-7432325297c0
md"""
!!! note

	Curenttly `Symbolics.solve_for()` only works if all of the equations are linear. 
"""

# ╔═╡ 40732796-a147-4236-a93d-a528d184571f
md"""
### Differential Calculus

A short example from Physics.

 $\text{velocity} \equiv f'(\text{position})$ \
 $\text{acceleration} \equiv f'(\text{velocity}) \equiv f''(\text{position})$
"""

# ╔═╡ 0323beea-7d2d-4fe5-ac8e-dfffc3180b0b
position = -16t^2 + 16t + 32

# ╔═╡ 163a831d-6e80-4c23-bb6c-6a5f757fd61f
D = Symbolics.Differential(t)

# ╔═╡ 6035a52d-a106-47c3-b0bb-a99f144c7069
position_dot = D(position)

# ╔═╡ b3f76d17-37bd-43ee-b555-552a823ccce9
velocity = Symbolics.expand_derivatives(position_dot)

# ╔═╡ 28e751a1-23c4-465f-8b9b-320083878fa5
position_ddot = D(velocity)

# ╔═╡ 8f5b8112-00b2-4eb2-a179-763ddb39cf82
acceleration = Symbolics.expand_derivatives(position_ddot)  # second derivative

# ╔═╡ 4952fba4-d908-4145-9738-5071c9da17d9
md"Time: $(@bind time Slider(0:10, 0, true))"

# ╔═╡ 0a125914-9ed7-4364-ac99-f907c395499e
position_at_time = Symbolics.substitute(position, Dict(t => time))

# ╔═╡ 993fd782-b0d7-4ace-8012-762d68d0caee
velocity_at_time = Symbolics.substitute(velocity, Dict(t => time))
