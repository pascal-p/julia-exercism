...
# ╔═╡ 8d605533-77b2-4c6d-9c66-488a0890c479
using PlutoUI

# ╔═╡ 81f888bd-1a93-4a42-af12-fc5af89d10d8
using Symbolics, SymbolicNumericIntegration

# ╔═╡ 505ed8da-d597-11ed-115a-4f254fb3ceb2
md"""
## Using `SymbolicNumericIntegration.jl`

Ref. [Symbolic Computation in Julia using Symbolics.jl, SymbolicNumericIntegration.jl and Pluto](https://www.youtube.com/watch?v=L47k2zjPU9s)

April 2023
"""


# ╔═╡ 0e84b543-d470-4310-bbbe-d60473cb5914
PlutoUI.TableOfContents(indent=true, depth=4, aside=true)

# ╔═╡ 301bf484-bd81-417b-83b0-cadc1e44ecdd
...
# ╔═╡ 5811b38f-a31e-447f-91f9-0d9fb394521f
md"""
### Define a symbolic variable
"""

# ╔═╡ 3258b5f1-df08-4ea6-9181-a84b9093a540
@variables x

# ╔═╡ 5fbebe89-a76a-45d1-aa3f-8c64ec8854a1
md"""
!!! note

	Currently, `SymbolicNumericIntegration.jl` package only works with expressions containing a single variable.
"""

# ╔═╡ f88e868d-61a0-413e-84a0-80b9da759a7d
md"""
### Example from the documentation
"""

# ╔═╡ ac219875-ab98-4eae-8eaf-2c633ed90dd5
expr₁ = 3x^3 +2x - 5 

# ╔═╡ e5361acc-645c-4d07-a569-858f40570b22
SymbolicNumericIntegration.integrate(expr₁)

# ╔═╡ 88c9abea-e9f6-492d-85b9-2c6651e9d7d5
md"""
The first element of the tuple solution above is the symbolic solution.\
The second is the residual unsolved portion of the input.\
The third is the numerical error for the current solution.

As long as the values of the second and third element of the tuple are close to zero, it is OK.
"""

# ╔═╡ 67973a52-db1a-4f12-8240-421259bccc8f
md"""
### Another example
"""

# ╔═╡ 3503eb35-2515-4032-a5a7-43dd75bbef3a
f = √x

# ╔═╡ 23a70f16-e332-496f-95c1-a915060edfd1
SymbolicNumericIntegration.integrate(f)

# ╔═╡ a96878a5-c4c2-4afd-b765-ac645eeba9f8
to_compute = SymbolicNumericIntegration.integrate(f)[1]

# ╔═╡ 6db66ff5-b4b0-43f6-b0b9-8bdedbe9c8dc
f_expr = SymbolicNumericIntegration.build_function(to_compute, x)  # getting an IR of this expression

# ╔═╡ d7ca891d-7593-40d8-8dcd-866a8c0bdc1d
 f_eval = SymbolicNumericIntegration.eval(f_expr)  # and now it can be used as any other `Julia` function

# ╔═╡ 1ffc80d0-0607-4c4a-a617-d172d6b58d73
area = f_eval(4)

# ╔═╡ f8957e86-eeaf-4273-beb3-3f91ba6d4263
html"""
<style>
  main {
...
[compat]
PlutoUI = "~0.7.50"
SymbolicNumericIntegration = "~1.0.0"
Symbolics = "~4.14.0"
"""
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "631cdf56a7c6a5351d9d1dbd1ab00255da96381c"
...
git-tree-sha1 = "76bfb5952ef6b66e1d3ae42c118b4990314c4e64"
