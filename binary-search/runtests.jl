...
@testset "default binary search" begin
    ...
    @testset "multiple matches" begin
      @test binarysearch([1, 1, 1, 2, 2, 3, 3, 4, 5], 2) == 4:5
      @test binarysearch([1, 2, 2, 2, 3, 3, 4, 4, 5], 2) == 2:4
      @test binarysearch([0, 1, 2, 2, 2, 3, 3, 3, 3, 3, 3, 4, 4, 5, 6, 7], 3) == 6:11
      @test binarysearch([1, 1, 2, 3, 3, 4], 1) == 1:2
      @test binarysearch([1, 2, 3, 4, 5, 6, 7, 7, 7, 7], 7) == 7:10
    end
end
